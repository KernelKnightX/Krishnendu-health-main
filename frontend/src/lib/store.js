...
const SEED_PRODUCTS = [
  ...["Baby Wet Wipes", "Baby Hand & Mouth Wipes", "Refreshing Wipes", "Bed Bath Wipes", "Face & Body Bath Towel", "Shampoo Bath Towel", "Nail Polish Remover Wipes", "Makeup Remover Wipes", "Surface Cleaning Wipes", "Sanitizing Wipes", "Intimate Hygiene Wipes", "Sexual Wellness Wipes", "Delay Wipes", "Pet Wet Wipes"].map((name) => ({ name, category: "Wipes" })),
